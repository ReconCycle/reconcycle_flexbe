...
class RBS_CallActionTFCartLin(EventState):
    ...
    def __init__(self, namespace, t, local_offset=0, global_pos_offset=0, limit_rotations=False):
        super(RBS_CallActionTFCartLin, self).__init__(outcomes = ['continue', 'failed'], input_keys = ['t2_data'], output_keys = ['t2_out'])
