...
'''
class Demo_za_EMO_Conf_2SM(Behavior):
	'''
	Potrebna oprema:
...
- Ponovi
	...
	def __init__(self):
		super(Demo_za_EMO_Conf_2SM, self).__init__()
		self.name = 'Demo_za_EMO_Conf_2'
	...
	def create(self):
		...
		_state_machine.userdata.holder_up_pose = "emo/j_holder_up_pose_conf2-1"
		_state_machine.userdata.j_pickup_pose = "emo/j_holder_pickup_pose_conf2-1"
		...
		_state_machine.userdata.j_above_slider = "emo/j_above_slider_conf2"
		_state_machine.userdata.j_slightly_above_slider = "emo/j_slightly_above_slider_conf2"
