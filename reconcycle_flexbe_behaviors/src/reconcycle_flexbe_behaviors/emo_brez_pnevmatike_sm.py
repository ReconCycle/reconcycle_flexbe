...
'''
class EMO_Brez_PnevmatikeSM(Behavior):
	'''
	Potrebna oprema:
...
- Ponovi
	...
	def __init__(self):
		super(EMO_Brez_PnevmatikeSM, self).__init__()
		self.name = 'EMO_Brez_Pnevmatike'
	...
	def create(self):
		...
		_state_machine.userdata.j_slightly_above_slider = "emo/j_slightly_above_slider_5"
