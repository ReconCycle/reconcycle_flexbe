...
"""
rostopic pub /qbsoftclaw/control/qbsoftclaw_position_and_preset_trajectory_controller/follow_joint_trajectory/goal control_msgs/FollowJointTrajectoryActionGoal "header:
  seq: 0
  stamp:
    secs: 0
    nsecs: 0
...
goal:
  trajectory:
    header:
      ...
      frame_id: ''
    joint_names:
    - ['qbsoftclaw_shaft_joint', 'qbsoftclaw_stiffness_preset_virtual_joint']
    points:
    - positions: [-0.5, -0.5]
      velocities: [0.1, 0.1]
